 ...
 */
public class Studentlistgate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_studentlistgate, container, false);


        cardid.add(new Studentcardid("name","present","40","1",R.drawable.themartian));

        gatename=(TextView) v.findViewById(R.id.gatenamegate);
        dbHandler = new MyDBHandler(getContext(), null, null, 7);
        String classno=dbHandler.classvalue();
       // Toast.makeText(getContext(),dbHandler.stringforroute(),Toast.LENGTH_SHORT).show();

        Typeface face= Typeface.createFromAsset(getActivity().getAssets(),"fonts/CabinSketch-Bold.ttf");
        Typeface facegate= Typeface.createFromAsset(getActivity().getAssets(),"fonts/Roboto-Black.ttf");
        gatename.setTypeface(facegate);

        NumberPicker np=(NumberPicker) v.findViewById(R.id.numberPickergate);
        ...
        TextView clasname=(TextView) v.findViewById(R.id.classnamegate);
        ...
        temp = new ArrayList<>();
        if(!dbHandler.activestudents(String.valueOf(classnumber)).equals("%")) {

            String Class1Student = dbHandler.activestudents(String.valueOf(classnumber));
        ...
        button = (Button) v.findViewById(R.id.button5gate);
    ...
    NumberPicker.OnValueChangeListener onValueChangeListener =
            ...
            new NumberPicker.OnValueChangeListener(){
                ...
                public void onValueChange(NumberPicker numberPicker, int i, int i1) {
                    ...
                    temp = new ArrayList<>();
                    if(!dbHandler.activestudents(String.valueOf(i1)).equals("%")) {

                        String Class1Student = dbHandler.activestudents(String.valueOf(i1));
